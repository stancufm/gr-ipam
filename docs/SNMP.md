...
| Cisco CBS350-48P-4G 3.0.0.69 | SHA/DES transactional adoption/cleanup pilot | sw49 reports the intended user/group with explicit SHA/DES and passed the shadow authPriv probe; save remains gated by the LibreNMS probe |
...
| Cisco SF250-24P 2.3.5.63 | transactional SHA/DES configure/rotate/cleanup | sw10 passed removal of its legacy community, authenticated probes from shadow and LibreNMS, the short `write` plus overwrite-prompt save dialect, final archive, phpIPAM association and LibreNMS add/poll |
| Cisco SG350-28P, SF350-24P, SG250X-24P and SG250-08HP 2.4.0.94 | transactional SHA/DES configure/rotate/cleanup | sw20, sw30 and sw31 passed structural and two-source authPriv verification, conditional save, archive and LibreNMS poll; sw20/sw30 validated legacy cleanup; sw26 confirmed safe adoption without configuration commands, explicit SHA/DES verification, both probes, one-item legacy cleanup and retest, save/archive, phpIPAM association and LibreNMS poll |
