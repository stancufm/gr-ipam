...
| Cisco SF250-24P 2.3.5.63 | configure/rotate/cleanup tranzacțional SHA/DES | sw10 a trecut eliminarea community-ului legacy, probele autentificate din shadow și LibreNMS, dialectul de save cu `write` scurt și prompt de suprascriere, arhiva finală, asocierea phpIPAM și add/poll LibreNMS |
| Cisco SG350-28P, SF350-24P, SG250X-24P și SG250-08HP 2.4.0.94 | configure/rotate/cleanup tranzacțional SHA/DES | sw20, sw30 și sw31 au trecut verificarea structurală, probele authPriv din ambele surse, save-ul, arhivarea și poll-ul LibreNMS; sw20/sw30 au validat cleanup-ul legacy; sw26 a confirmat adoptarea sigură fără comenzi de configurare, verificarea SHA/DES explicită, ambele probe, eliminarea unei community legacy și retestarea, save/arhivă, asocierea phpIPAM și poll-ul LibreNMS |
