...
No passwords, SSH keys or GPG keys are copied by this installer.
EOF
}
...
python3 -m py_compile "$package_dir/bin/gr" "$package_dir/libexec/validate-ssh" "$package_dir/libexec/collect-version"
