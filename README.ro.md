...
gr device rename 192.0.2.10
gr device rename 192.0.2.10 --apply
...
Versiunea `2.13.1` nu include credențiale, chei, exporturi de inventar sau adrese interne. Proiectul este disponibil sub [licența MIT](LICENSE).
